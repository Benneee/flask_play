...
from flaskplay import db, bcrypt
from flaskplay.users.forms import (
    RegistrationForm, 
    LoginForm, 
    UpdateAccountForm, 
    RequestResetForm, 
...
from flaskplay.users.utils import send_reset_email, save_picture
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('If this email is registered with us, an email will be sent with instructions to reset your password', 'success')
        return redirect(url_for('users.login'))
